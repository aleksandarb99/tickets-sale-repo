Vue.component("manifestations", {
  ...
  template: ` 
        <div style="min-height:90vh;" class="container">
          ...
          <button class="btn btn-lg btn-primary" v-on:click="addManifestation">Add</button>
          <button class="btn btn-lg btn-secondary" v-on:click="editManifestation" v-bind:disabled="selectedManifestation.name ==undefined && mode!='EDIT '">Edit</button>
          <br />
          <div v-if="mode != 'HIDE'" class="container"> 
