  ...
  <nav style="min-height:10vh;" class="container-fluid navbar navbar-expand-md navbar-dark bg-dark mb-4">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li v-if="Object.keys(user).length == 6 || Object.keys(user).length == 7" class="nav-item active">
        ...
        <li v-if="Object.keys(user).length == 9 || Object.keys(user).length == 6" class="nav-item active">
